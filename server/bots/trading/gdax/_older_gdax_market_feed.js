...
// const numMinutes = 5;
// const numBins = 26;
// var pollingRate = numMinutes * (60 * 1000);  //get from server every 60 seconds
//
// var marketData = {
//   init: async (io) => {
//
...
//
//   updateEMA: async () => {
//     var historicalData = await marketData.getHistoricalData(BTC_USD, numMinutes, numBins);  //pair, minutes, numBins
//     var longEMA = marketData.calculateEMA(historicalData, longRange);  //intervals to calculate against
//     var shortEMA = marketData.calculateEMA(historicalData, shortRange);
